  ...
  useEffect(() => {
    ...
    if (!useAuthStore.getState().accessToken) {
      ...
      if (accessToken && refreshToken) {
        console.log('DashboardLayout: Cargando tokens desde localStorage al store');
    ...
    if (isAuthenticated()) {
      console.log('DashboardLayout: Usuario autenticado inicialmente');
      setIsChecking(false);
      return;
    }
    ...
    const checkAuth = setTimeout(() => {
      console.log('DashboardLayout: Verificando autenticación con retraso...');
      ...
      if (!isAuthenticated()) {
        ...
        console.log('DashboardLayout: Usuario autenticado después de retraso');
        setIsChecking(false);
      }
    }, 800);
